		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "감가상각 조회",
									"targetURL": "#anln1displayanln1display-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"anln1displayanln1display-display": {
								"semanticObject": "anln1displayanln1display",
								"action": "display",
								"description": "감가상각 조회",
								"title": "감가상각 조회",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=anln1display.anln1display",
									"url": sap.ui.require.toUrl("anln1display/anln1display")
								}
							}
						}
					}
