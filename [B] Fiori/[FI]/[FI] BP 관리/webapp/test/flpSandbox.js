		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "BP Display",
									"targetURL": "#bpcontrolbpcontrol-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bpcontrolbpcontrol-display": {
								"semanticObject": "bpcontrolbpcontrol",
								"action": "display",
								"description": "Business Partner Control Program",
								"title": "BP Display",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bpcontrol.bpcontrol",
									"url": sap.ui.require.toUrl("bpcontrol/bpcontrol")
								}
							}
						}
					}
